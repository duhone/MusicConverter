...
namespace CR::Engine::Core {
	...
	// Similar to Handle, but will decrement a reference count when destroyed. Can be moved, but not
	// copied. Does not delete anything on its own, just decrements a ref count.
	export template<typename TAG>
	class OwningHandle {
	public:
