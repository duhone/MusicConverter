...
namespace CR::Engine::Core {
	// For when you need to control when construction/destruction happens, but you want	the actual
	// memory to be in-situ. follows std::optional api as appropriate. intended only for member
	// variables.
